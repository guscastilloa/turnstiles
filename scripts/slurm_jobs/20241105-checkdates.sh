#!/bin/bash
#SBATCH --job-name=check_dates    # Job name
#SBATCH --output=logs/check_dates_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/check_dates_%j.err    # Error file
...
srun $python_path check_time_patterns.py
