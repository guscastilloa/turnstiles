#!/bin/bash
#SBATCH --job-name=id_mappings    # Job name
#SBATCH --output=logs/slurm/id_mappings%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/slurm/id_mappings%j.err    # Error file
