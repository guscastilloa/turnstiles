#!/bin/bash
#SBATCH --job-name=sort_P2000    # Job name
#SBATCH --output=logs/sort_P2000_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/sort_P2000_%j.err    # Error file
...
srun $python_path 20241018_sort_P2000_csv.py
