#!/bin/bash
#SBATCH --job-name=coincidences_sample    # Job name
#SBATCH --output=logs/coincidences_sample_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/coincidences_sample_%j.err    # Error file
...
srun $python_path coincidences.py 
