#!/bin/bash
#SBATCH --job-name=coincidences_sample_bins    # Job name
#SBATCH --output=logs/coincidences_sample_bins_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/coincidences_sample_bins_%j.err    # Error file
...
srun $python_path coincidences_bins.py 
