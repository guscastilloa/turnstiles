#!/bin/bash
#SBATCH --job-name=coincidences_4s_full    # Job name
#SBATCH --output=logs/coincidences_4s_full_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/coincidences_4s_full_%j.err    # Error file
...
srun $python_path parallel-coincidences.py --window 4
