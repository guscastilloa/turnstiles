#!/bin/bash
#SBATCH --job-name=parallel_coincidences_full    # Job name
#SBATCH --output=logs/parallel_coincidences_full_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/parallel_coincidences_full_%j.err    # Error file
...
srun $python_path parallel-coincidences.py 
