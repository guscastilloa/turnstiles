#!/bin/bash
#SBATCH --job-name=parallel_coincidences    # Job name
#SBATCH --output=logs/parallel_coincidences_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/parallel_coincidences_%j.err    # Error file
