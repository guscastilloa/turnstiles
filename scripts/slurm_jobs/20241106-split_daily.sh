#!/bin/bash
#SBATCH --job-name=split_daily    # Job name
#SBATCH --output=logs/split_daily_%j.log   # Output file (%j = job ID)
#SBATCH --error=logs/split_daily__%j.err    # Error file
...
srun $python_path 20241018_split_daily_csv.py
